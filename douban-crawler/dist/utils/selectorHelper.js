...
class SelectorHelper {
     ...
     */
    static findValueByLabel($, $container, labelText) {
     ...
     * 提取所有标签
     */
    static extractTags($, selector = '#db-tags-section .tag') {
        const tags = [];
     ...
     * 提取简介文本
     */
    static extractIntro($, selector = '.intro p') {
        const paragraphs = [];
        $(selector).each((index, element) => {
